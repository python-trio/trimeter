...
project = 'trimeter'
copyright = 'The trimeter authors'
author = 'The trimeter authors'
...
latex_documents = [
    (master_doc, 'trimeter.tex', 'Trio Documentation',
     author, 'manual'),
]
...
man_pages = [
    (master_doc, 'trimeter', 'trimeter Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'trimeter', 'trimeter Documentation',
     author, 'trimeter', 'A simple but powerful job scheduler for Trio programs',
     'Miscellaneous'),
]
